...
class ScreenManager {
    constructor(stage, assetManager, levelgen) {
        ...
        this.pressedStart = new createjs.Event("pressedStart", true, false);
    ...
    showMainMenu() {
        ...
        this.startButton.on("click", (e) => {
            this.stage.dispatchEvent(this.pressedStart);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("629a1067b4f3bf11a08e")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3ec0319d21ce77a44b89.hot-update.js.map