...
function onReady(e) {
    ...
    for (let i = 0; i <= 6; i++) {
        ...
        if ((0, Toolkit_1.randomMe)(1, 4) == 1) {
            sportsCar = new SportsCar_1.SportsCar(stage, assetManager, chicken, yValue);
            sportsCar.positionMe();
        }
        else if ((0, Toolkit_1.randomMe)(1, 4) == 2) {
            sedan = new Sedan_1.Sedan(stage, assetManager, chicken, yValue);
            sedan.positionMe();
        }
        else {
            police = new PoliceCar_1.PoliceCar(stage, assetManager, chicken, yValue);
            police.positionMe();
        }
        yValue = yValue + 31;
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ee72d19cd2802ec702ea")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.24ac0d009f63973f2848.hot-update.js.map