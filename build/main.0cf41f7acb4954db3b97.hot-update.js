    ...
    genLevels() {
        ...
        if (levelType == 1) {
            ...
            for (let i = 0; i < 20; i++) {
                ...
                if (newYPos == 1)
                    this.yValue = (0, Toolkit_1.randomMe)(470, 570);
                else if (newYPos == 2)
                    this.yValue = (0, Toolkit_1.randomMe)(180, 280);
                if (obstacleType == 1) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("105826c3aa95348caa4b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.0cf41f7acb4954db3b97.hot-update.js.map