...
function onKeyDown(e) {
    if (e.key == "w" && isPlaying == true)
        upKey = true;
    else if (e.key == "s" && isPlaying == true)
        downKey = true;
    else if (e.key == "a" && isPlaying == true)
        leftKey = true;
    else if (e.key == "d" && isPlaying == true)
        rightKey = true;
}
function onKeyUp(e) {
    if (e.key == "w" && isPlaying == true)
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bc7e3c5eb12aa7826548")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.e12a77e748347578ceb3.hot-update.js.map