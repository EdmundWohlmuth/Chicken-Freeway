...
function onReady(e) {
    ...
    laneOne = assetManager.getSprite("sprites", "Land Tiles/Grass_LG", 0, 505);
    stage.addChild(laneOne);
    laneTwo = assetManager.getSprite("sprites", "Land Tiles/Grass_LG", 0, 409);
    stage.addChild(laneTwo);
    laneThree = assetManager.getSprite("sprites", "Land Tiles/Road_3_Lane", 0, 320);
    stage.addChild(laneThree);
    laneFour = assetManager.getSprite("sprites", "Land Tiles/Grass_LG", 0, 200);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("b18c6d9132039741a4e1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.27acaac87c0de8a47830.hot-update.js.map