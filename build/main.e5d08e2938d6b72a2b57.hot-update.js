...
class LevelGeneration {
    constructor(stage, assetManager, chicken, sportsCar, police, sedan, nest, corn) {
        ...
        this.laneThree = assetManager.getSprite("sprites", "Land Tiles/Dirt_M", 0, 288);
        this.levelFour.addChild(this.laneThree);
        this.trainTrack = assetManager.getSprite("sprites", "Land Tiles/Tracks", 0, 288);
    ...
    genLevels() {
        this.clearLevel();
        let levelType = (0, Toolkit_1.randomMe)(1, 4);
        if (levelType == 1) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("27d6b68657ee68ad012d")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.e5d08e2938d6b72a2b57.hot-update.js.map