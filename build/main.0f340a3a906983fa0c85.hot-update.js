...
class LevelGeneration {
    constructor(stage, assetManager, chicken, sportsCar, police, sedan, nest) {
        ...
        this.speed = Constants_1.STARTING_CAR_SPEED;
    ...
    genLevels() {
        ...
        for (let i = 0; i < this.carArray.length; i++) {
            this.carArray[i].speed = this.carArray[i].speed + Constants_1.CAR_SPEED_INCREASE;
        }
    ...
    clearLevel() {
        this.speed = this.carArray[1].speed;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("066340882cd8cbf2735f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.0f340a3a906983fa0c85.hot-update.js.map