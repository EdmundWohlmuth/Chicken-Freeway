...
class StopLight {
    ...
    SwitchStates() {
        if (this._train.sprite.x > -500 && this._train.sprite.x < Constants_1.STAGE_WIDTH + this.trainWidth) {
            this._sprite = this.assetManager.getSprite("sprites", "Lights/Stop", 10, 315);
        }
        else {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("fab9dcd19549176f71ec")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.8f1325b6a803c28e2fdf.hot-update.js.map