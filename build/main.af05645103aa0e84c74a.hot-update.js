...
class Train {
    ...
    positionMe() {
        this._sprite.x = (0, Toolkit_1.randomMe)(-400, (Constants_1.STAGE_WIDTH + 400));
        this._sprite.y = 305;
        this.stage.addChild(this._sprite);
    }
    update() {
        this._sprite.x = this._sprite.x + this._speed;
        if (this._sprite.x > (Constants_1.STAGE_WIDTH + 400)) {
            this._sprite.x = -400;
        }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("fec56098955600ad3223")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.af05645103aa0e84c74a.hot-update.js.map