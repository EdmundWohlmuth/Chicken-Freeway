    ...
    genLevels() {
        ...
        if (levelType == 1) {
            ...
            for (let i = 0; i < 20; i++) {
                ...
                let newYPos = (0, Toolkit_1.randomMe)(1, 2);
                if (newYPos == 1)
                    this.yValue = (0, Toolkit_1.randomMe)(96, 180);
                else if (newYPos == 2)
                    this.yValue = (0, Toolkit_1.randomMe)(490, 550);
                if (obstacleType == 1) {
                    this.obstacleArray.push(this.largeRock = new LargeRock_1.LargeRock(this.stage, this.assetManager, this.chicken));
                    this.largeRock.positionMe(this.yValue);
                    this.levelTwo.addChild(this.largeRock.sprite);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("077f2d2808f89959d27b")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.de62f33e03a2331515d8.hot-update.js.map